...
var GameRuleService = /** @class */ (function () {
    function GameRuleService(httpService) {
    ...
    GameRuleService.prototype.getAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.httpService.get('p2e/players/@me/game-rules')];
                    case 1:
                        response = _a.sent();
    ...
    GameRuleService.prototype.isUserQualified = function (user, gameRule) {
        return utils_1.ScrimLang.checkIfRequirementsFitsObject(gameRule.requirements, user.stats);
    };
